...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/irajmoradi/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/irajmoradi/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |        10m 0.039s         |        1m 19.59s          | 
| `pg_normalized_batch`  |         1m 51.548s        |          14.19s           | 
| `pg_denormalized`      |       19.112s             |         4.47s             | 
